...
Function        : Convolutional LSTM for many to one prediction
...
Description     : This module provides several methods to perform deep learning
                  ...
                  Shi et. al. (2015) for the prediction of precipitation. Their paper
...
Caveat!         : This module get input as a spatial-temporal sequence and make a prediction for only one step!!
                  In the sentence of deep learning, this is known as many-to-one prediction.
"""
...
class ConvLSTMCell(nn.Module):
    def __init__(self, input_channels, hidden_channels, kernel_size):
        ...
        #assert hidden_channels % 2 == 0, "The number of hidden channels should not be even number!"
...
class ConvLSTM(nn.Module):
    ...
    def forward(self, x, timestep):
        ...
        for i in range(self.num_layers):
            ...
            x, new_c = getattr(self, name)(x, h, c) # output new x will be taken as input x for the next hidden layer
